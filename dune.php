    ...
    <main>
      ...
      <section class="movies">
                ...
                <div class="tab-content" id="tabContent">
                  <div class="tab-pane fade show active" id="eps1" role="tabpanel">
                    <div class="ratio" style="--bs-aspect-ratio: 50%">
                      <iframe
                        src="https://brontoplaystorage.blob.core.windows.net/brontoplayfilm/Dune _ Official Main Trailer.mp4 "
                        frameborder="0"
        ...
        <div class="details">
          <div class="row">
            <div class="col-md-2">
              <img src="./assets/images/movies/dune.jpg" class="details-img" />
            </div>
            <div class="col-md-10">
              <h1>Dune</h1>
              <p class="status-film">
                <div class="badge bg-success">Original</div> | <div class="badge bg-secondary">13+</div> | <div class="badge bg-warning">2021</div> | <div class="badge bg-spanrimary">3:13:00</div>
              </p>
              ...
              <p class="genre">Genre : Sci-fi (Science Fiction)</p>
              <p class="negara">Negara : Amerika Serikat dan Britania Raya</p>
              <p class="sutradara">Sutradara : Denis Villeneuve</p>
              <p class="pemain">Pemain : Rebecca Ferguson, Zendaya, oscar isaac, Timothee Chalame.</p>
