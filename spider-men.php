    ...
    <main>
      ...
      <section class="movies">
                ...
                <div class="tab-content" id="tabContent">
                  <div class="tab-pane fade show active" id="eps1" role="tabpanel">
                    <div class="ratio" style="--bs-aspect-ratio: 50%">
                      <iframe
                        src="https://brontoplaystorage.blob.core.windows.net/brontoplayfilm/Spider-Man_ No Way Home – Official Trailer.mp4"
                        frameborder="0"
        ...
        <div class="details">
          <div class="row">
            <div class="col-md-2">
              <img src="./assets/images/movies/spider-men.jpg" class="details-img" />
            </div>
            <div class="col-md-10">
              <h1>Spider Man: Far From Home</h1>
              <p class="status-film">
                <div class="badge bg-success">Original</div> | <div class="badge bg-secondary">13+</div> | <div class="badge bg-warning">2017</div> | <div class="badge bg-spanrimary">3:31:19</div>
              </p>
              ...
              <p class="sutradara">Sutradara : Jon Watts</p>
