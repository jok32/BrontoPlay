...
<head>
  ...
  <link rel="stylesheet" href="./assets/css/corousal.css">
    ...
    <main>
        ...
        <div class="banner-card">
          <div class="carousel">
            <div class="carousel-inner">
                <div class="carousel-item"><img src="./assets/images/movie.jpg" class="banner-img" alt=""><div class="carousel-content">
                  
                </div></div>
                <div class="carousel-item"><img src="./assets/images/radi.png" class="banner-img" alt=""></div>
                <div class="carousel-item"><img src="./assets/images/action.jpg" class="banner-img" alt=""></div>
                <div class="carousel-item"><img src="./assets/images/aven.jpg" class="banner-img" alt=""></div>
            </div>
      ...
      <section class="movies">
        ...
        <!--
          - load more button
        -->
        <a href="movie.php"><button class="load-more">LOAD MORE</button></a>
      ...
      <section class="category" id="category">
        ...
        <div class="category-grid">
          ...
          <div class="category-card">
            <img src="./assets/images/radio/iradio.jpg" alt="" class="card-img">
            <div class="total">105.7 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/mnc.jpg" alt="" class="card-img">
            <div class="total">104.6 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/hard.png" alt="" class="card-img">
            <div class="total">87.7 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/trax.png" alt="" class="card-img">
            <div class="total">95.1 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/bbc.jpg" alt="" class="card-img">
            <div class="total">87.7 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/vibe.jpg" alt="" class="card-img">
            <div class="total">98.8 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/global.png" alt="" class="card-img">
            <div class="total">88.4 FM</div>
          </div>

          <div class="category-card">
            <img src="./assets/images/radio/urban.png" alt="" class="card-img">
            <div class="total">181 FM</div>
          </div>

        </div>

        <br><br><a href="radio.php"><button class="load-more">LOAD MORE</button></a>
